...
{
	t_shape			shape = new_sphere();
	t_intersection	*i = intersection(3.5, shape);
...
{
	t_shape	shape = new_sphere();
	t_intersection	*i1 = intersection(1, shape);
	t_intersection	*i2 = intersection(2, shape);
...
Test(the_hit, when_some_intersections_have_negative_t_)
{
	t_shape	shape = new_sphere();
	t_intersection	*i1 = intersection(-1, shape);
	t_intersection	*i2 = intersection(1, shape);
	t_intersections	xs = (t_intersections){0};
...
{
	t_shape	shape = new_sphere();
	t_intersection	*i1 = intersection(-2, shape);
	t_intersection	*i2 = intersection(-1, shape);
	t_intersections	xs = (t_intersections){0};
...
{
	t_shape	shape = new_sphere();
	t_intersection	*i1 = intersection(5, shape);
	t_intersection	*i2 = intersection(7, shape);
	t_intersection	*i3 = intersection(-3, shape);
	t_intersection	*i4 = intersection(2, shape);
	t_intersections	xs = (t_intersections){0};
